/**
 * Pokédex Interativa — script.js
 * Consome a PokéAPI para exibir informações dos Pokémon.
 */
...
const INITIAL_LIMIT = 40;   // Pokémon carregados ao iniciar
const LOAD_MORE_LIMIT = 40; // Pokémon adicionados ao clicar "Carregar mais"
